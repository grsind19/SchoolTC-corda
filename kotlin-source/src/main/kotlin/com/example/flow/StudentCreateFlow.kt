...
object StudentCreateFlow {
    @InitiatingFlow
    @StartableByRPC
    class Initiator (val student: Student) : FlowLogic<SignedTransaction>(){
        /**
        ...
        override  fun call(): SignedTransaction{
            ...
            val studentState = StudentState(student.studentId, student.studentName, student.dob, student.fatherName, student.motherName, student.gender, student.standard, "Y", student.school, student.deo)
